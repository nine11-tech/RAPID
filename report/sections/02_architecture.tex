...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{figures/lambda_architecture.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{figures/single_host_vs_distributed.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{figures/tailscale_swarm_layers.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{figures/runtime_communication.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{figures/api_bridge.tex}}
