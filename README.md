...
|---|---:|---|---|
| Anass | `100.73.xx.xx` | `anass` | `zookeeper`, `kafka`, `namenode`, `datanode`, `flask-api` |
| Hamza | `100.72.xx.xx` | `hamza` | `spark-master`, `spark-worker` |
| Khalid | `100.127.xx.xx` | `khalid` | `spark-streaming` |
| Chawi | `100.97.xx.xx` | `chawi` | `cassandra`, `hbase`, `nginx-dashboard` |
...
```env
ANASS_IP=100.xx.xx
HAMZA_IP=100.72.xx.xx
KHALID_IP=100.127.xx.xx
CHAWI_IP=100.97.xx.xx
...
```bash
docker swarm init --advertise-addr 100.73.xx.xx
...
| Service | URL |
|---|---|
| HDFS NameNode UI | `http://100.73.xx.xx:9870` |
| Kafka broker | `100.73.xx.xx:9092` |
| Flask API | `http://100.73.xx.xx:5000` |
| Spark master UI | `http://100.72.xx.xx:8080` |
| Hamza Jupyter | `http://100.72.xx.xx:8888` |
| Khalid Jupyter | `http://100.127.xx.xx:8889` |
| HBase UI | `http://100.97.xx.xx:16010` |
| HBase Thrift | `100.97.xx.xx:9090` |
| Cassandra | `100.97.xx.xx:9042` |
| Dashboard | `http://100.97.xx.xx:3000` |
...
```bash
API_BASE=http://100.73.xx.xx:5000 \
ORIGIN=http://100.97.xx.xx:3000 \
